...
<head>
  ...
  <title>Registrasi Akun - Sistem Informasi Bengkel Mobil</title>
  ...
  <style>
    .login-wrapper{
      ...
      border-radius:2px;
      box-shadow:0px 0px 15px rgb(22, 22, 19),
      5px 5px 25px rgb(22, 22, 19);
    }
    .p-2{
      padding:20px;
    }
          ...
          <div class="login-wrapper p-2">
            <div class="box">
              <div class="content-wrap">
                ...
                <h3>Sistem Informasi Bengkel Mobil</h3>
                <span><i>CV. Bengkel Babe</i></span>
                <p><?php echo $this->session->flashdata('msg'); ?></p>
                <hr />
                <form action="<?php echo base_url() . 'Daftar/tambahUser' ?>" method="post">
                  ...
                  <div class="form-group">
                    <div class="form-label-group">
                      ...
                      <a href="<?php echo base_url('Login');?>" class="btn btn-warning btn-block">Kembali </a>
                      <br>
                </form>
              </div>
            </div>
